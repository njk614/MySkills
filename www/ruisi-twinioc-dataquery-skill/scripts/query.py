...
_DEFAULT_SERVICE_BASE_URL = os.getenv("TWINEASY_BASE_URL", "https://www.twinioc.net").rstrip("/")
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--base-url", default=None, help="孪易服务基础地址，默认 https://www.twinioc.net")
    # MCP 查询模式
    parser.add_argument(
        "--mcp-tool",
        default=None,
